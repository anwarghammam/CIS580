...
# save to files
        ...
        #     res=0
        #     res=solution.objectives[0]*0.1+solution.objectives[1]*0.2+solution.objectives[2]*0.1+solution.objectives[3]*0.2+solution.objectives[4]*0.2+solution.objectives[5]*0.2
        #     resultat.append(res)
    ...
    print_function_values_to_file(non_violated_front,r"/home/anwar/Desktop/NSGAIII/approach3/function_values"+str(max_evaluations)+".txt")
    print_variables_to_file(non_violated_front, r"/home/anwar/Desktop/NSGAIII/approach3/variables"+str(max_evaluations)+".txt")
